...
| M3 | System Architecture & Infrastructure Setup | 29 Jun – 19 Jul 2026 | Abdullah + Omer | 🔄 In Progress |
...
Detailed week-by-week task plans are stored as individual files: `m1-week-plan.md`, `m2-week-plan.md`, etc.
